...
class HSToolBar: UIToolbar {
    ...
    func initToolBarView() {
        ...
        self.btnDone.setTitle("D", for: UIControlState.normal)
        
        self.btnDone.setTitleColor(UIColor.black, for: UIControlState.normal)
        ...
        if self.isDoneOnly {
            ...
            self.btnPrevious.setTitle("L", for: UIControlState.normal)
            self.btnPrevious.setTitleColor(UIColor.black, for: UIControlState.normal)
            ...
            self.btnNext.setTitle("R", for: UIControlState.normal)
            self.btnNext.setTitleColor(UIColor.black, for: UIControlState.normal)
